...
function install(){
 ...
 const group=document.createElement('div');group.className='v08x-mode-group mode-pane';
 ...
 const panel=document.createElement('div');panel.className='v08x-settings settings';panel.innerHTML='<b>阅读设置</b><label>字号 <input id="v08xFont" type="range" min="15" max="25" value="18"></label><button id="v08xDark">深色/浅色</button><p style="font-size:12px;color:var(--muted)">点击设置框外关闭。</p>';document.body.append(panel);
 ...
 const anchors=document.createElement('div');anchors.className='v08x-compat-anchor';anchors.innerHTML='<span class="viewer figure-index reference-pop annotation-panel study"></span><span id="rightResizeHandle"></span>';document.body.append(anchors);
